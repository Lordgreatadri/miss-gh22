...
<div id="pcoded" class="pcoded">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    ...
                                                    <br>
                                                    <h6 style="color: maroon;">Please press the <b>cast vote</b> button to cast vote </h6>
                                                </div>
                                            </div>
                                        </div>

                                        <?php 
                                        $query = "SELECT * FROM contestants /*WHERE status = 'Active'*/ ORDER BY num_of_votes DESC";
                                                ...
                                                <div class="col-md-3 default-grid-item">
                                                    <div class="card gallery-desc">
                                                        ...
                                                        <div class="masonry-media"><!-- <?php //echo $get_result["contestant_id"];?> voteidentifier -->
                                                            <a class="media-middle voter" href="#!" data-contestant-id ='<?php echo $get_result["contestant_id"];?>' data-contestant-num ='<?php echo $get_result["contestant_num"];?>'  data-contestant-name ='<?php echo $get_result["contestant_name"];?>' data-category ='<?php echo $get_result["contestant_region"];?>'>
                                                                <img class="img-fluid" src='<?php echo $get_result["thumbnail"];?>' alt='<?php echo $get_result["contestant_name"];?>'>
                                                            </a>
                                                        </div>
                                                        <div class="card-block">
                                                            <a class="viewProfile1 btn btn-sm " href="https://mysmsinbox.com/miss_ghana/profile.php?me=<?php echo $get_result['contestant_id'];?>&q=<?php echo $get_result['contestant_name'];?>" style="border: 3px solid #f39f23; background: #e10988; color: #fff;">  <b>View Profile</b></a>


                                                            <!-- <h6 class="job-card-desc">
                                                             <b>Full Name: </b>   <?php// echo $get_result['full_names'];?>
                                                            </h6> -->
                                                            <h6 class="job-card-desc">
                                                             <b> Name: </b>   <?php echo $get_result['contestant_name'];?>
                                                            </h6>
                                                            <p class="text-muted">
                                                              <b>Region:  </b>  <?php echo $get_result['contestant_region'];?>
                                                            </p> 
                                                           <!--  <div class="job-meta-data">
                                                              <b>Age: </b>  <?php //echo $get_result['age'];?>
                                                            </div> -->
                                                            ...
                                                            <!-- <div class="job-meta-data" style="color: #4B0082;">
                                                              <b>Votes: </b>  <?php //echo $get_result['num_of_votes'];?>
                                                            </div> -->
                                                            <div class="job-meta-data"><!-- <?php //echo $get_result["contestant_id"];?> -->
                                                               <button style="border: 3px solid #f39f23; background-color: #6d5f43; color: white;" id="btnsubmit" class='btn btn-sm btn-primary1 voter ' data-contestant-id ='<?php echo $get_result["contestant_id"];?>' data-contestant-num ='<?php echo $get_result["contestant_num"];?>'  data-contestant-name ='<?php echo $get_result["contestant_name"];?>' data-category ='<?php echo $get_result["contestant_region"];?>'  > <b>Cast Vote </b></button>

                                                                  <a id="mobile-share"  href="whatsapp://send?text=https://mysmsinbox.com/miss_ghana/mycontent.php?me=<?php echo $get_result['contestant_id'];?>&q=<?php echo $get_result['contestant_name'];?>" data-action="share/whatsapp/share"><button class="btn btn-default btn-sm whats" style="color: black; border: 1px;  border-color:blue;"><img src="share.jpg" height="20"/><b>Share</b></button></a>


                                                                   <a id="mobile-share"  href="http://www.facebook.com/sharer/sharer.php?u=https://mysmsinbox.com/miss_ghana/mycontent.php?me=<?php echo $get_result['contestant_id'];?>&q=<?php echo $get_result['contestant_name'];?>" data-action="share/facebook/share"><button class="btn btn-default btn-sm whats" style="color: black; border: 1px;  border-color:blue;"><img src="face.jpg" height="20"/><b>Share</b></button></a>  
                                 ...
                                 <form  name="payment" id="payment" class="payment"  onsubmit="return validateEntryForm();">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="amount" class="form-control amount" id="amount">
                                                    ...
                                                    <option value="1000">₵1000.00 => 1000 votes</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group inline">
                                               ...
                                               <!--  <label class="radio-inline">
                                                    ...
                                                    <img src="../web_vendors/assets/images/logo_airtel.png" style="margin-top: 0px; margin-bottom: 5px; border-radius: 100%; width: 35px; height: 35px;" class="img-fluid">
                                                </label> -->
                                                ...
                                                <label class="radio-inline">
                                                 ...
                                                 <label class="radio-inline">
                                                  ...
                                                  <label class="checkbox-inline" id="termsCheck">
                                                    ...
                                                    <span class="text-danger"><small> <a href="#termsModal" class="text-danger termslink" id="termslink" style="text-decoration: underline;">Accept Terms and Conditions</a></small></span>
                                                    <span class="btn btn-md btn-info termslink" id="termslink" style="border-radius: round;" > <small>Accept terms and condition to vote with visa.</small></span>
                                                 </label>
                                    ...
                                    <div class="row" id="opt_div">
                                        <div class="form-group col-md-10 col-sm-10">
                                            <label for="token" style="margin: 10px;">Enter the OPT Token sent to your phone</label>
                                            <input type="text" class="form-control" name="opt_code" id="opt_code" placeholder="Enter OPT Code" style="margin: 10px;" >
                                            <!-- <br> -->
    ...
    <div class="fixed-bottom footer-div" style="display: flex;  flex-direction: column; align-items: end; background: inherit;">
            <div class="footer-div-content" style="display: flex; flex-direction: row; justify-content: center;">
                <p style="color: #02a2ff ;"><b>Powered By </b></p>&emsp;
                <a href="http://www.mobilecontent.com.gh" target="_blank"> <b><i style="color: #f39f23;"> MyCediPay</i></b></a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       // const channel = document.forms['payment']['channel'];
...
<script >
    ...
    function checkIfTermsChecked(){
        if(document.getElementById('terms').checked && document.getElementById('visa_card').checked) {
