<?php
    ...
    $insertUserQuery = "UPDATE log_hist SET ussd_channel_viewer = 'USSD Channel Tab Viewed' WHERE session_id = '$session_id' AND username = '$username'";
    mysqli_query($database, $insertUserQuery);


    $ussd_user = "";
    $nominee   = "";
    if (isset($_GET['view_ussd_action'])) 
    {
        $ussd_user = trim($_GET['nominee']);    
        $nominee   = trim($_GET['view_ussd_action']);
    }
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="text-center">USSD voting details for <b> <?php echo $ussd_user; ?></b></h5>
                                    <?php 
                                          //session_start();
                                ...
                                <span style="float: right;">
                                    <button class="btn btn-secondary"> <a style="text-decoration: none; color: white;" href="controllers/export_contestantchannel.php?channel=<?php echo 'ussd'; ?>&nominee=<?php echo $nominee; ?>"><b>Export Data</b></a></button>
                                </span>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            ...
                                            $stmnt = "SELECT * FROM momo_completed_transactions WHERE category = '$nominee' AND device = 'ussd' ORDER BY `tansactions_date` DESC LIMIT 0,1000";
