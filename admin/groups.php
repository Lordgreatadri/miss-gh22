...
?>
        ...
        <div class="container-fluid main-div">
            <div class="row">
                ...
                <div class="col-md-2 side-div">
                    ...
                    <li class="selected"><a href="groups.php"><span class="lnr lnr-users"></span> Groups</a></li>
                ...
                <div class="container-fluid content-div">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <h5 class="text-center"><b>Groups details and their perfomance</b></h5><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6 class="text-center"><b>Statistics of Weekly Votes [<a href="#stats-detail-modal" data-toggle="modal"><small>view full screen</small></a>]  &nbsp;&nbsp; [<a href="controllers/export_group-vote.php"><small>export data</small></a>]</b></h6>
        ...
        <div class="modal fade full-screen-modal" id="leaderboard-detail-modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-white"><b>Group Overall Vote Statistics</b></h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script>
    ...
    //CONTESTANTS PAGE CONTROLLER CONSTANTS.GET_CONTESTANTS_SUMMARY_URL
function getContestantsSummary() {
    $.get('controllers/get-group-summary.php', function(response) {
        if (response.success) {
            var template = ``;
            var counter = 1;
            var statusClassName = '';
...
// <th scope="col">Code</th>      <td>${item.contestant_num}</td>
                ...
                response.data.forEach( function(item) {
                    ...
                    `;//<button class="btn btn-sm bg-danger" onclick='toggleEvictionStatus(${itemObj})'>${statusBtnName}</button>
...
// show leaderboard graph CONSTANTS.GET_CONTESTANTS_LEADERBOARD_URL
function showLeaderBoardGraph() {
    $.get('controllers/get-group-leaderboard.php', function(response) {
        var data = response.graph.data,
            labels = response.graph.labels;

        var ctx = document.getElementById("leaderboardChart").getContext('2d');
        drawBarChart(ctx, data, labels, 'Leading Groups');
    })
}

// show fullscreen of results CONSTANTS.GET_CONTESTANTS_LEADERBOARD_URL
...
// show leaderboard results for the week CONSTANTS.GET_WEEKLY_CONTESTANTS_LEADERBOARD_URL
function showContestantLeaderBoardForWeek() {
    $.get('controllers/get-weekly-group-leaderboard.php', function(response) {
        ...
        drawBarChart(ctx, data, labels, 'Leading Group This Week');
    })
}

//CONSTANTS.GET_WEEKLY_CONTESTANTS_LEADERBOARD_URL
