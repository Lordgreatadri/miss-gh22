...
require_once 'controllers/db-config.php';
    ...
    $insertUserQuery = "UPDATE log_hist SET raw_channel_viewer = 'Raw Channel Tab Viewed' WHERE session_id = '$session_id' AND username = '$username'";
    ...
    if (isset($_GET['all_channel_action'])) 
    {
        ...
        $nominee   = trim($_GET['all_channel_action']);
    }
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="text-center">All voting details for <b> <?php echo $ussd_user; ?></b></h5>
                                    <?php 
                                          //session_start();
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            $i = 1;
                                            // include '/controllers/db-config.php';#4kLxMzGurQ7Z~
                                            // $conn      = new mysqli('localhost','root', '', 'gadangme');
                                            $stmnt = "SELECT * FROM momo_completed_transactions WHERE category = '$nominee' AND response_code = '0000' ORDER BY `tansactions_date` DESC LIMIT 0,100";
