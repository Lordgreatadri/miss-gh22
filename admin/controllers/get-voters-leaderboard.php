<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        $query = "SELECT DISTINCT `momo_number` as voter_num, SUM(number_of_votes) as vote_num FROM `transactions_completed` WHERE response_code = '0000' GROUP BY `momo_number` ORDER BY vote_num DESC LIMIT 5";
