<?php
  ...
  include_once "db-config.php";
    ...
    $sql = "SELECT contestant_name AS 'NAME', status AS STATUS,  num_of_votes AS VOTES, updated_at AS 'LAST VOTED' FROM contestants_weekly WHERE status = 'not_evicted' ORDER BY num_of_votes DESC";
