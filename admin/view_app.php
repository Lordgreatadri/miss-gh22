<?php
    ...
    $insertUserQuery = "UPDATE log_hist SET android_channel_viewer = 'App Channel Tab Viewed' WHERE session_id = '$session_id' AND username = '$username'";
    ...
    {
    	$app_user = trim($_GET['nominee']);
        $nominee   = trim($_GET['app_action']);	
    }
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light navbar-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://bit.ly/akyem" target="_blank">Cast Vote</a>
                    </li>
        ...
        <div class="container-fluid main-div">
            <div class="row">
                ...
                <div class="col-md-2 side-div">
                    ...
                    <li><a href="http://bit.ly/akyem" target="_blank"><span class="lnr lnr-thumbs-up"></span> Cast Vote</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5 class="text-center">Mobil app vote details for <b> <?php echo $app_user; ?></b></h5>
                                    <?php 
                                          //session_start();
                                ...
                                <span style="float: right;">
                                    <button class="btn btn-secondary"> <a style="text-decoration: none; color: white;" href="controllers/export_contestantchannel.php?channel=<?php echo 'android'; ?>&nominee=<?php echo $nominee; ?>"><b>Export Data</b></a></button>
                                </span>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                         ...
                                         <?php
                                            ...
                                            $stmnt = "SELECT * FROM momo_completed_transactions WHERE contestant_num = '$nominee' AND device = 'android' ORDER BY `tansactions_date` DESC LIMIT 0,1000";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rows['momo_number'];?></td>
                                        <td> <?php echo $rows['device'];?></td>
               <!-- trash-o -->         <td> <?php echo $rows['vote_count'];?></td>
               							<!-- <td> <?php //echo $rows['amount'];?></td> -->
               							<td> <?php echo $rows['tansactions_date'];?></td>
