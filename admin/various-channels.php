<?php
    ...
    $insertUserQuery = "UPDATE log_hist SET various_channels = 'Channel Tab Viewed' WHERE session_id = '$session_id' AND username = '$username'";
        ...
        <div class="container-fluid main-div">
            <div class="row">
                ...
                <div class="col-md-2 side-div">
                    ...
                    <li class="selected"><a href="#"><span class="lnr lnr-users"></span> Various Channels</a></li>
                    <li class=""><a href="vote_channels.php"><span class="lnr lnr-laptop"></span> Various Channels</a></li>
